...
EXPANSION_MSAS = {
    ...
    "37980": MSAInfo("37980", "Philadelphia-Camden-Wilmington", "PA-NJ-DE-MD", ["Philadelphia"]),
    "40060": MSAInfo("40060", "Richmond", "VA", ["Richmond"]),
    
    # National primary markets  
    "35620": MSAInfo("35620", "New York-Newark-Jersey City", "NY-NJ-PA", ["New York City"]),
...
def get_msa_display_names() -> Dict[str, str]:
    ...
    return {code: f"{info.name} ({info.state})" 
            for code, info in ACTIVE_MSAS.items()}
