...
class SimplifiedPropertyInput:
    ...
    def is_mixed_use(self) -> bool:
        ...
        return (self.commercial_units is not None and 
                self.commercial_units.total_units > 0)
    ...
    def calculate_key_metrics(self) -> Dict[str, Any]:
        ...
        if self.purchase_price:
            metrics.update({
                ...
                'total_cash_required': self.purchase_price * (self.equity_structure.self_cash_percentage / 100),
                'gross_cap_rate': self.get_annual_gross_rent() / self.purchase_price
            })
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'SimplifiedPropertyInput':
        ...
        return cls(
            ...
            ) if data['commercial_units_count'] > 0 else None,
            renovation_info=RenovationInfo(
    ...
    def to_legacy_format(self) -> PropertyInputData:
        ...
        return PropertyInputData(
            ...
            physical_info=PropertyPhysicalInfo(
                property_type=PropertyType.MIXED_USE if self.is_mixed_use() else PropertyType.MULTIFAMILY,
...
class PropertyDataManager:
    ...
    def __init__(self):
        self.properties: Dict[str, Union[PropertyInputData, SimplifiedPropertyInput]] = {}
        self.logger = get_logger(self.__class__.__name__)
    
    def add_property(self, property_data: Union[PropertyInputData, SimplifiedPropertyInput]) -> bool:
    ...
    def get_property(self, property_id: str) -> Optional[Union[PropertyInputData, SimplifiedPropertyInput]]:
        """Get property by ID."""
    ...
    def get_simplified_properties(self) -> List[SimplifiedPropertyInput]:
        ...
        return [p for p in self.properties.values() if isinstance(p, SimplifiedPropertyInput)]
...
def validate_property_data(property_data: Union[PropertyInputData, SimplifiedPropertyInput]) -> List[str]:
    ...
    try:
        ...
        if isinstance(property_data, SimplifiedPropertyInput):
            ...
            if property_data.commercial_units and property_data.commercial_units.total_units < 0:
