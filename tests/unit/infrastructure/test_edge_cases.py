...
from src.infrastructure.repositories.sqlite_parameter_repository import SQLiteParameterRepository
from src.infrastructure.repositories.sqlite_simulation_repository import SQLiteSimulationRepository
    ...
    def test_repository_with_readonly_database_should_handle_gracefully(self):
        ...
        try:
            ...
            with pytest.raises(DatabaseError):
                ...
                from src.domain.entities.forecast import ParameterId, DataPoint, HistoricalData
    ...
    def test_repository_transaction_rollback_on_error(self):
        ...
        try:
            ...
            with patch.object(repo, '_get_connection') as mock_get_conn:
                mock_conn = Mock()
                mock_cursor = Mock()
                mock_cursor.execute.side_effect = sqlite3.OperationalError("Simulated error")
                mock_conn.cursor.return_value = mock_cursor
