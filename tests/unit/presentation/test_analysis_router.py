...
def mock_services():
    ...
    with patch("src.presentation.api.dependencies.get_dcf_services") as mock_get_dcf_services, \
         patch("src.presentation.api.dependencies.get_dcf_assumptions_service") as mock_dcf_assumptions, \
         patch("src.presentation.api.dependencies.get_initial_numbers_service") as mock_initial_numbers, \
         patch("src.presentation.api.dependencies.get_cash_flow_projection_service") as mock_cash_flow, \
         patch("src.presentation.api.dependencies.get_financial_metrics_service") as mock_financial_metrics, \
         patch("src.presentation.api.dependencies.get_forecasting_service") as mock_forecasting, \
         patch("src.presentation.api.dependencies.get_monte_carlo_service") as mock_monte_carlo:
...
class TestAnalysisRouter:
    ...
    def test_single_property_dcf_analysis_success(self, client, auth_headers, mock_services):
        """Test successful single property DCF analysis."""
        # Mock service responses
        mock_assumptions = Mock()
        mock_assumptions.scenario_name = "TEST_SCENARIO"
        mock_services.dcf_assumptions.create_dcf_assumptions_from_scenario.return_value = mock_assumptions
        
        mock_initial = Mock()
        mock_initial.total_cash_required = 100000
        mock_initial.ltv_ratio = 0.75
        mock_services.initial_numbers.calculate_initial_numbers.return_value = mock_initial
        
        mock_projection = Mock()
        mock_projection.total_noi = 50000
        mock_projection.total_distributions = 75000
        mock_services.cash_flow_projection.calculate_cash_flow_projection.return_value = mock_projection
        ...
        mock_services.financial_metrics.calculate_financial_metrics.return_value = mock_metrics
    ...
    def test_single_property_dcf_analysis_service_error(self, client, auth_headers, mock_services):
        """Test single property DCF analysis with service error."""
        mock_services.dcf_assumptions.create_dcf_assumptions_from_scenario.side_effect = Exception("Service error")
    ...
    def test_single_property_dcf_analysis_with_monte_carlo(self, client, auth_headers, mock_services):
    ...
    def test_batch_property_dcf_analysis_success(self, client, auth_headers, mock_services):
    ...
    def test_batch_property_dcf_analysis_partial_failure(self, client, auth_headers, mock_services):
        ...
        mock_services.dcf_assumptions.create_dcf_assumptions_from_scenario.side_effect = side_effect
    ...
    def test_batch_property_dcf_analysis_validation_error(self, client, auth_headers):
        ...
        invalid_request = {
            "properties": []  # Empty list should cause validation error
        }

        response = client.post(
            "/api/v1/analysis/dcf/batch", 
            json=invalid_request,
            headers=auth_headers
        )
    ...
    def test_error_response_format(self, client, auth_headers, mock_services):
        ...
        mock_services.dcf_assumptions.create_dcf_assumptions_from_scenario.side_effect = ValueError("Test error")
    ...
    def test_concurrent_batch_processing_limit(self, client, auth_headers, mock_services):
        ...
        mock_services.cash_flow_projection.calculate_cash_flow_projection.return_value = Mock()
        mock_services.financial_metrics.calculate_financial_metrics.return_value = Mock()
