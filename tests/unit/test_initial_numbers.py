...
class TestInitialNumbersService:
    ...
    def create_sample_property(self) -> SimplifiedPropertyInput:
        ...
        return SimplifiedPropertyInput(
            ...
            residential_units=ResidentialUnits(
                total_units=10, average_rent_per_unit=3000
            ),
            ...
            equity_structure=InvestorEquityStructure(
                investor_equity_share_pct=75.0, self_cash_percentage=30.0
            ),
            city="New York",
            state="NY",
            msa_code="35620",
    ...
    def test_operating_expense_calculations(self):
        ...
        assert (
            abs(initial_numbers.total_operating_expenses - expected_total_expenses)
            < 1000
        )
    ...
    def test_validation_functionality(self):
        ...
        major_issues = [
            issue
            for issue in issues
            if "error" in issue.lower() or "negative" in issue.lower()
        ]
