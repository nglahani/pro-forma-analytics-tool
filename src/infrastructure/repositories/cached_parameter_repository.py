...
from src.domain.entities.forecast import ParameterId, HistoricalData, ForecastResult
...
class CachedParameterRepository:
    ...
    def insert_or_replace_data_point(self, parameter_id: ParameterId, 
                                   date: date, value: float, data_source: str) -> None:
...
class CachedDatabaseManager:
    ...
    def invalidate_parameter_cache(self, parameter_name: str, 
                                 geographic_code: Optional[str] = None) -> int:
