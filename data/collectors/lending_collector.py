...
class LendingRequirementsCollector(BaseDataCollector):
    ...
    def get_available_parameters(self) -> List[str]:
        ...
        return ["ltv_ratio", "closing_cost_pct", "lender_reserves"]
    ...
    def get_market_summary(
        self, geographic_code: str, as_of_date: date
    ) -> Dict[str, float]:
        ...
        for param_name in self.get_available_parameters():
            try:
                ...
                data = self.collect_data(
                    param_name, geographic_code, as_of_date, as_of_date
                )
                if not data.empty:
